 ...
 * Author(s): Zidmann
 * Function : This class contains the webService client JUnit tests to check if there was no regression in flood protection module through ApplicationCore module.
 * Version  : 1.0.0 
