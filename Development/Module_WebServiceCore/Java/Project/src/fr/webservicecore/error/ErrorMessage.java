...
/** 
 * Basic attributes of an error message coming from a NodeJS server using the module entitled 'WebServiceCore'
...
{
	/**
	 * Name of the webservice running under the NodeJS server using the Core module
	 */
	@Expose
	@Since(1.0)
	 ...
	 */
	public ErrorMessage(String service, String version, String code, String message, String stack,  int status){
	...
	public String toString() {
		return "ErrorMessage [service="+ this.service +", version=" + super.getVersion() + ", code=" + super.getCode() + ", message=" + super.getMessage() + ", stack=" + super.getStack() + ", status=" + super.getStatus() + "]";
	}
}