...
import fr.webservicecore.toolbox.ErrorTool;
...
public class AttributesTool extends fr.core.toolbox.AttributesTool
{
	 ...
	 * @throws APIException containing the error message whose code is 'WSCORE-JAR-1'
	 */
	public static void isEmptyThrowsError(String str) throws APIException{
		if(isEmpty(str)){
        	APIException objectDBExpct = new APIException();
        	objectDBExpct.setErrorMsg(ErrorTool.getMessageByCode("WSCORE-JAR-1"));
	 ...
	 * @param str String to check
	 * @throws APIException containing the error message whose code is 'WSCORE-JAR-2'
	 */
	public static void checkRegexThrowsError(String str) throws APIException{
		if(!checkRegex(str)){
        	APIException objectDBExpct = new APIException();
        	objectDBExpct.setErrorMsg(ErrorTool.getMessageByCode("WSCORE-JAR-2"));
