...
/* 
 * Class 	: TestCase_Contributor_ErrorMsg
 * Author(s): Zidmann
 * Function : This class contains the webService client JUnit tests to check if there was no regression in Contributor service 
 * Version  : 1.0.0 
