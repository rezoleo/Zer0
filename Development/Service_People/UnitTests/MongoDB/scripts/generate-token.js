 ...
 * Author(s)	: Zidmann
 * Function 	: Script used to generate the differents tokens used for testing the card service with JUnit scripts.
 * Version  	: 1.0.0
 */
...
token_list.push(require('../tokens/token_people.js'));
