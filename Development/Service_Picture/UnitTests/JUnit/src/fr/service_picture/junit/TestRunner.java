package fr.service_picture.junit;
...
import fr.service_picture.junit.test.TestSuite_ServicePicture;
...
public class TestRunner {
	public static void main(String[] args) {
		Result rslt = JUnitCore.runClasses(TestSuite_ServicePicture.class);
