...
public class TestCase_Card extends TestCase_Model
{
	...
	public void testCardClientAPI() throws Exception{
		...
		checkCardQuantity(0);
		Card card1=ws_client_card.createCard("ownerone", "cde1ffff", "ON", "creatoro");
		assertNotNull(card1);
		...
		checkCardQuantity(1);
		Card card2=ws_client_card.createCard("ownertwo",  "cde2bbbb", "ON", "creatort");
		assertNotNull(card2);
		assertNotNull(card2.get_id());
		assertNotNull(card2.getCreated());
		Card cardRef2 = new Card(card2.get_id(), "ownertwo", "cde2bbbb", "ON", "creatort",
		...
		Card cardRef3 = new Card(card3.get_id(), "ownertwo", "cde2bbbb", "ON",
		...
		//Update one card1
		checkCardQuantity(2);
		Card card4=ws_client_card.updateCard(card2.get_id(), "ownersix", "cde3cccc", "ON", "updator");
