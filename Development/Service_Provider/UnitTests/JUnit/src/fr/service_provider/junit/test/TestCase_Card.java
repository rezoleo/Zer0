 ...
 * Class 	: TestCase_Card
 * Author(s): Zidmann
 * Function : This class contains the webService client JUnit tests to check if there was no regression in Provider service for Card service 
 * Version  : 1.0.0 
...
public class TestCase_Card extends TestCase_Model
{
	...
	public void testCardClientAPI() throws Exception{
		...
		checkCardQuantity(0);
		Card card1=ws_client_card.createCard("ownerone", "cde1ffffffffff", "ON", "creatoro");
		assertNotNull(card1);
		...
		checkCardQuantity(1);
		Card card2=ws_client_card.createCard("ownertwo",  "cde2bbbbbbbbbb", "ON", "creatort");
		assertNotNull(card2);
		assertNotNull(card2.get_id());
		assertNotNull(card2.getCreated());
		Card cardRef2 = new Card(card2.get_id(), "ownertwo", "cde2bbbbbbbbbb", "ON", "creatort",
		...
		Card cardRef3 = new Card(card3.get_id(), "ownertwo", "cde2bbbbbbbbbb", "ON",
		...
		//Update one card1
		checkCardQuantity(2);
		Card card4=ws_client_card.updateCard(card2.get_id(), "ownersix", "cde3cccccccccc", "ON", "updator");
