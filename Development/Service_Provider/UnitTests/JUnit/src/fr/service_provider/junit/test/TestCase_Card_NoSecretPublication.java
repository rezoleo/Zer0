...
/**
 * This class contains the webService client JUnit tests to check if the version (__v), the IP (creatorIP, updatorIP) are not shown when data are extracted from Provider service through Card service
 * <p>
